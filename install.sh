...
SCHEME_VARIANTS=('' '-Nord' '-Dracula' '-Gruvbox' '-Everforest' '-Catppuccin' '-Flexoki')
...
OPTIONS:
  ...
  --tweaks                Specify versions for tweaks
                          1. [nord|dracula|gruvbox|everforest|catppuccin|flexoki|all]  (Nord/Dracula/Gruvbox/Everforest/Catppuccin/Flexoki/all) ColorSchemes version
